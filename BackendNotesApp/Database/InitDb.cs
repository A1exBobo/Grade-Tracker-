...
using BackendNotesApp;
    ...
    public class InitializeDatabase
    {
        ...
        public InitializeDatabase()
        {
            ...
            "CREATE TABLE Materie(ID int,Nume varchar(50) not null,NumarCredite int not null,PondereCurs int not null,SemestruID int not null,CursID int not null,LaboratorID int);"+
